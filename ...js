  ...
  **Emoji eski haline getirildi ve yetkili jaile atıldı!**`)
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("ready", () => {
      ...
      client1.on("ready", () => {
        client1.channels.cache.get(' Ses Kanalı ID').join();
        });
      
      client2.on("ready", () => {
        client2.channels.cache.get(' Ses Kanalı ID').join();
        });
      
      client3.on("ready", () => {
        client3.channels.cache.get(' Ses Kanalı ID').join();
        });
      
      client4.on("ready", () => {
        client4.channels.cache.get(' Ses Kanalı ID').join();
        });
